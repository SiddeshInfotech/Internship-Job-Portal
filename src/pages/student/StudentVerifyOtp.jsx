              ...
              <>
                <div className="text-center mb-8">
                  ...
                  <p className="text-sm font-medium text-slate-500 mt-3 leading-relaxed">
                    {email ? (
                      <>We sent a 6-digit code to <br/><span className="inline-block mt-1 font-bold text-blue-600 bg-blue-50 px-2 py-0.5 rounded-md">{email}</span></>
                    ) : (
                ...
                <form onSubmit={handleVerify} className="space-y-6">
                  ...
                  <div className="space-y-1.5 group">
                    <label className="text-[12px] font-bold text-slate-500 uppercase tracking-wider block text-center group-focus-within:text-blue-600 transition-colors">
                      Verification Code
                    </label>
                    <input
                      type="text" 
                      ...
                      maxLength={6} 
                      required
                      className="w-full px-4 py-4 rounded-xl bg-slate-50 border border-slate-200/80 text-2xl font-bold font-mono text-slate-800 tracking-[0.5em] text-center outline-none transition-all duration-300 focus:bg-white focus:ring-4 focus:ring-blue-600/10 focus:border-blue-600 shadow-[0_2px_10px_rgb(0,0,0,0.01)] hover:border-slate-300"
                    />
                  </div>
